    ...
    <div class="towork-title">
        <div class="container-fluid">
            ...
            <div id="mydiv">
                ...
                <p class="MsoNormal" style="margin-top: 6.0pt;"><span style="font-size: 18pt;"><strong><span id="order-num">Квитанция о приёмке № <?php echo $order_num; ?></span> от <?php echo $last_entry['data_open']; ?></strong></span></p>
                <hr />
