    ...
    <div class="towork-title">
        <div class="container-fluid">
            ...
            <div id="mydiv">
                ...
                <p class="MsoNormal" style="margin-top: 6.0pt;"><span style="font-size: 18pt;"><strong><span id="order-num">Квитанция о приёмке № <?php echo $order_num; ?></span> от <?php echo $data_open; ?></strong></span></p>
                <hr />
                ...
                <p class="MsoNormal" style="margin-top: 6pt; line-height: 0.9;"><span style="font-size: 10pt;">
                        ...
                        4. Срок хранения аппарата 30 дней с момента приёма устройства в ремонт. После данного срока, если клиент не интересуется устройством, либо с ним не возможно связаться, устройство утилизируется, и претензии по нему не принимаются.<br />
                        5. В случае отказа заказчика от ремонта устройства стоимость диагностики неисправности платная.<br />
                        6. В случае утери квитанции, устройство выдаётся по предъявлению паспорта на имя заказчика.</span></p>
                <table style="height: 15px; width: 100%; border-style: none;" border="0">
                    <tbody>
                    <tr style="height: 15px;">
                        <td style="width: 50%; height: 15px;"><span style="font-size: 14pt;"><img style="position: absolute; z-index: 1; top: 410px; left: 60px; width: 150px; height: 150px;" src="img/GWstamp.png" alt="">Исполнитель: _______________ / <?php echo $_SESSION['user']['full_name'] ?>/</span></td>
                        <td style="width: 50%; height: 15px; text-align: right;"><span style="font-size: 11pt;">С условием гарантии ознакомлен и согласен </span><span style="font-size: 14pt;">________________ / <?php echo $first_name; ?>/</span></td>
                    </tr>
                    <tr>
