    ...
    <div class="towork-title">
        <div class="container-fluid">
            ...
            <form action="create.php" method="post">
                ...
                <div class="form-group">
                    <textarea class="form-control" type="text" name="comment_order" placeholder="Комментарий к заказу (со слов клиента)"></textarea>
                </div>

                <div class="form-group">
                    <input type="hidden" name="rank_id" value="6">
                    <input type="hidden" name="visible" value="1">
                    <button class="btn btn-danger btn-lg btn-block" type="submit">Добавить</button>
                </div>
