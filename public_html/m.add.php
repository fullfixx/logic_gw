...
<main>
    ...
    <div class="towork-title">
        <div class="container-fluid">
            ...
            <form action="m.create.php" method="post">
                ...
                <div class="form-group">
                    <select class="form-control" type="number" name="order_type" required>
                        <option value="4">Тип заказа "C"</option>
                        <?php
                ...
                <div class="form-group">
                    <select class="form-control" type="number" name="executor" required>
                ...
                <div class="form-group">
                    ...
                    <button class="btn btn-danger btn-lg btn-block" type="submit">Создать квитанцию</button>
                </div>
